...
import { testCategories, divingSpots } from "../fixtures.js";
...
suite("Category Model tests", () => {
  ...
  test("create a category", async () => {
    const category = await db.categoryStore.addCategory(divingSpots);
    assertSubset(divingSpots, category);
  ...
  test("get a category - success", async () => {
    ...
    assertSubset(divingSpots, returnedCategory);
  });
